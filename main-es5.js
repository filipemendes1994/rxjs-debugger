...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function AppComponent(fakeService) {
      ...
      _createClass(AppComponent, [{
        ...
        value: function ngAfterViewInit() {
          ...
          rxjs_debugger__WEBPACK_IMPORTED_MODULE_4__["RxJSDebugger"].valueChanges.subscribe(function () {
            return _this.consoleLogger('Subscription map value changed!');
          });
          rxjs_debugger__WEBPACK_IMPORTED_MODULE_4__["RxJSDebugger"].obSubscribed$.subscribe(function (className) {
            return _this.consoleLogger("Observable subscribed on ".concat(className, "!"));
          });
          rxjs_debugger__WEBPACK_IMPORTED_MODULE_4__["RxJSDebugger"].obUnsubscribed$.subscribe(function (className) {
            return _this.consoleLogger("Observable unsubscribed on ".concat(className, "!"));
          });
        }
      }, {
        key: "ngOnDestroy",
        ...
        key: "addSubscriptionLogic",
        value: function addSubscriptionLogic(randomNumber) {
          rxjs_debugger__WEBPACK_IMPORTED_MODULE_4__["RxJSDebugger"].addOnSubscribeLogic(function () {
            return console.log(randomNumber);
          });
          this.randomNumber = this.getRandomNumber();
        }
      }, {
        key: "addUnsubscriptionLogic",
        value: function addUnsubscriptionLogic(randomNumber) {
          rxjs_debugger__WEBPACK_IMPORTED_MODULE_4__["RxJSDebugger"].addOnUnsubscribeLogic(function () {
            return console.log(randomNumber);
          });
          this.randomNumber = this.getRandomNumber();
        }
      }, {
        key: "clearSubscriptionLogic",
        value: function clearSubscriptionLogic() {
          rxjs_debugger__WEBPACK_IMPORTED_MODULE_4__["RxJSDebugger"].clearOnSubscribeLogic();
        }
      }, {
        key: "clearUnsubscriptionLogic",
        value: function clearUnsubscriptionLogic() {
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 28,
      vars: 2,
      consts: [[1, "main-container"], [1, "btns-actions"], [1, "btns-actions__item", "btns-actions__item--primary", 3, "click"], [1, "btns-actions__item", "btns-actions__item--other", 3, "click"], [1, "btns-actions__item", "btns-actions__item--secundary", 3, "click"], [1, "console"], ["console", ""]],
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_button_click_2_listener() {
            return ctx.addSubscription(ctx.AvailableSource.COMPONENT);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_button_click_4_listener() {
            return ctx.addSubscription(ctx.AvailableSource.PIPE);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_button_click_6_listener() {
            return ctx.addSubscription(ctx.AvailableSource.SERVICE);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_button_click_8_listener() {
            return ctx.addSubscription(ctx.AvailableSource.DIRECTIVE);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_button_click_10_listener() {
            return ctx.addSubscriptionLogic(ctx.randomNumber);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_button_click_12_listener() {
            return ctx.addUnsubscriptionLogic(ctx.randomNumber);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_button_click_14_listener() {
            return ctx.clearSubscriptionLogic();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_button_click_16_listener() {
            return ctx.clearUnsubscriptionLogic();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_button_click_18_listener() {
            return ctx.printSubscriptionsMap();
          });
  ...
  function srcAppAppConstantsTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "AvailableSource", function () {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _pipes_fake_pipe__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./pipes/fake.pipe */
    "./src/app/pipes/fake.pipe.ts");
    /* harmony import */


    var _directives_fake_directive__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./directives/fake.directive */
    "./src/app/directives/fake.directive.ts");
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"], _pipes_fake_pipe__WEBPACK_IMPORTED_MODULE_3__["FakePipe"], _directives_fake_directive__WEBPACK_IMPORTED_MODULE_4__["FakeDirective"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppDirectivesFakeDirectiveTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "FakeDirective", function () {
    ...
    FakeDirective.ɵfac = function FakeDirective_Factory(t) {
      return new (t || FakeDirective)();
    };

    FakeDirective.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({
      type: FakeDirective,
      selectors: [["", "appFakeDirective", ""]]
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FakeDirective, [{
  ...
  /***/
  function srcAppPipesFakePipeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "FakePipe", function () {
      return FakePipe;
    });
    /* harmony import */
    ...
    FakePipe.ɵfac = function FakePipe_Factory(t) {
      return new (t || FakePipe)();
    };

    FakePipe.ɵpipe = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefinePipe"]({
      name: "fakePipe",
      type: FakePipe,
      pure: true
    });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FakePipe, [{
  ...
  function srcAppServicesFakeServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    FakeService.ɵfac = function FakeService_Factory(t) {
      return new (t || FakeService)();
    };

    FakeService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: FakeService,
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FakeService, [{
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/filipemendes/code/rxjs-monitor/demo/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
